...
<Disclosure as="nav" class="bg-white- bg-gray-800 dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600" v-slot="{ open }">
